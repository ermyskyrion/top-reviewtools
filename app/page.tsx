...
const categories = [
  {
    name: 'AI Writing',
    icon: '✍️',
    description: 'Content creation, copywriting & editing tools',
    href: '/blog',
    bg: 'bg-violet-50',
  ...
  },
  {
    name: 'Productivity',
    icon: '⚡',
    description: 'Task management, automation & focus tools',
    href: '/blog',
    bg: 'bg-amber-50',
  ...
  },
  {
    name: 'Video & Design',
    icon: '🎨',
    description: 'AI video generation, image & design tools',
    href: '/blog',
    bg: 'bg-rose-50',
